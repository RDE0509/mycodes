...
# print('*'*5,'!! Ajay Love Calculator !!','*'*5)
...
# n1 = (input('enter your lovers name :\n'))


# print("!!! Get ready for result !!! \n")
# print(n)
# print("\u2764\uFE0F")
# print(n1)
...
root.title('ajay  love Calculator')
...
# Heading on Top
heading = Label(root, text='ajay love Calculator')
heading.pack()
...
slot2 = Label(root, text="Enter Your lover's Name:")
slot2.pack()
